...
## Branching model
We use the git-flow branching model. The base branch is `main`. If you are looking for a stable version, please use the main branch or tags labeled as v1.x.x.
