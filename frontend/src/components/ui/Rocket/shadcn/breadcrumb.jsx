...
function BreadcrumbItem({ className, ...props }) {
  return (
    <li data-slot="breadcrumb-item" className={cn('tw-inline-flex tw-items-center tw-gap-1', className)} {...props} />
  );
}
...
function BreadcrumbEllipsis({ className, ...props }) {
  return (
    <span
      ...
      role="presentation"
      aria-hidden="true"
      className={cn('tw-flex tw-size-5 tw-items-center tw-justify-center [&>svg]:tw-size-4', className)}
      {...props}
    >
      <MoreHorizontalIcon />
