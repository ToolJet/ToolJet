    ...
    <div className={`${darkMode ? 'theme-dark dark-theme' : ''} basic-plan-migration-banner`}>
      <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px', color: '#1B1F24' }}>
        ...
        <p className="banner-text">
          {t('basicPlanMigrationBanner.prefix', 'We will be updating our domain on')}{' '}
          <span className="banner-link-date">
            {t('basicPlanMigrationBanner.date', "24th November '25")}
          </span>{' '}
          {t('basicPlanMigrationBanner.impact', 'which will impact any SSO configured.')}{' '}
          <a
            ...
            rel="noreferrer"
          >
            {t('basicPlanMigrationBanner.readDocs', 'Read docs')}
          </a>{' '}
          {t('basicPlanMigrationBanner.toKnowMore', 'to know more.')}
        </p>
        {/* <div
