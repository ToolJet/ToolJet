          ...
          <div className="card-header">
            ...
            <div className="tj-drawer-tabs-container-outer">
              <div className="tj-drawer-tabs-container">
                ...
                >
                  <SolidIcon name="mail" width="14" fill={DarkMode ? (activeTab == 1 ? '#FFF' : '#687076') : (activeTab == 1 ? '#000' : '#687076')} />
                ...
                >
                  <SolidIcon name="fileupload" width="14" fill={DarkMode ? (activeTab == 1 ? '#FFF' : '#687076') : (activeTab == 1 ? '#000' : '#687076')} />
