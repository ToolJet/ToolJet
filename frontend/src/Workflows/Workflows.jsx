...
class WorkflowsComponent extends React.Component {
  constructor(props) {
    super(props);
  ...
  fetchApps = (page = 1, folder, searchKey) => {
    ...
    appService.getAll(page, folder, appSearchKey, 'workflow').then((data) =>
      this.setState({
        apps: data.apps,
                ...
                <div className="p-3 create-new-app-wrapper">
                  <Dropdown as={ButtonGroup} className="w-100 d-inline-flex">
                    ...
                    >
                      ...
                      {this.props.t('workflow.header.createNewWorkflow', 'New workflow')}
                    </Button>
