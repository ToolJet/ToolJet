...
export const UpdateRows = ({ currentState, optionchanged, options, darkMode }) => {
  ...
  const [updateRowsOptions, setUpdateRowsOptions] = useState(options['update_rows'] || { columns: { 0: {} } });
  const [whereFilters, setWhereFilters] = useState(updateRowsOptions['where_filters'] || { 0: {} });
  ...
  const handleColumnChange = (index, value) => {
    const prevUpdateRowsColumnsOptions = { ...updateRowsOptions['columns'] };
    prevUpdateRowsColumnsOptions[index].column = value;

    setUpdateRowsOptions({
      ...updateRowsOptions,
      ...{ columns: prevUpdateRowsColumnsOptions },
    });
  };

  const handleValueChange = (index, value) => {
    const prevUpdateRowsColumnsOptions = { ...updateRowsOptions['columns'] };
    prevUpdateRowsColumnsOptions[index].value = value;
  ...
  const handleDelete = (index) => {
    const prevUpdateRowsColumnsOptions = { ...updateRowsOptions['columns'] };
    delete prevUpdateRowsColumnsOptions[index];
  ...
  return (
    <>
      ...
      {updateRowsOptions['columns'] &&
        Object.values(updateRowsOptions['columns']).map((columnOption, index) => {
          return (
            <div key={index} className="my-2 row">
              ...
              <div className="col-6">
                <CodeHinter
                  ...
                  initialValue={
                    columnOption['value']
                      ? typeof columnOption['value'] === 'string'
                        ? columnOption['value']
                        : JSON.stringify(columnOption['value'])
                      : columnOption['value']
                  }
                  lineNumbers={false}
      ...
      <div
        className="cursor-pointer py-3"
        onClick={() =>
          setUpdateRowsOptions((prevUpdateRowsOptions) => {
            return {
              ...prevUpdateRowsOptions,
              ...{
                columns: {
