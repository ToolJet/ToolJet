...
export const QueryManagerHeader = forwardRef(
  ({ darkMode, options, editorRef, setActiveQueryHeaderTab, activeQueryHeaderTab }, ref) => {
                ...
                (tab) =>
                  (tab.condition === undefined || tab.condition) && (
                    <p
                      ...
                      onClick={() => setActiveQueryHeaderTab(tab.id)}
                      style={{
                        borderBottom: activeQueryHeaderTab === tab.id ? '2px solid #3E63DD' : '',
                        cursor: 'pointer',
                        padding: '0px 8px 6px 8px',
                        color: activeQueryHeaderTab === tab.id ? 'var(--text-default)' : 'var(--text-placeholder)',
                      }}
                    >
                      {tab.label}
                    </p>
