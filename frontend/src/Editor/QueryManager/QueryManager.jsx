          ...
          <div className="col-auto px-1 m-auto">
            {selectedDataSource && (addingQuery || editingQuery) && (
              <button
                ...
                style={{ height: '28px' }}
              >
                <span style={{ marginRight: '10px' }}>{this.props.t('editor.queryManager.preview', 'Preview')}</span>
                <span className={`${this.props.darkMode && 'filter-invert-dark-mode'}`}>
                  <svg width="14.43" height="10" viewBox="0 0 22 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M11 11.75C12.1833 11.75 13.1875 11.3375 14.0125 10.5125C14.8375 9.6875 15.25 8.68333 15.25 7.5C15.25 6.31667 14.8375 5.3125 14.0125 4.4875C13.1875 3.6625 12.1833 3.25 11 3.25C9.81665 3.25 8.81249 3.6625 7.98749 4.4875C7.16249 5.3125 6.74999 6.31667 6.74999 7.5C6.74999 8.68333 7.16249 9.6875 7.98749 10.5125C8.81249 11.3375 9.81665 11.75 11 11.75ZM11 10.3C10.2167 10.3 9.55415 10.0292 9.01249 9.4875C8.47082 8.94583 8.19999 8.28333 8.19999 7.5C8.19999 6.71667 8.47082 6.05417 9.01249 5.5125C9.55415 4.97083 10.2167 4.7 11 4.7C11.7833 4.7 12.4458 4.97083 12.9875 5.5125C13.5292 6.05417 13.8 6.71667 13.8 7.5C13.8 8.28333 13.5292 8.94583 12.9875 9.4875C12.4458 10.0292 11.7833 10.3 11 10.3ZM11 15C8.69999 15 6.60415 14.375 4.71249 13.125C2.82082 11.875 1.35832 10.225 0.324988 8.175C0.274988 8.09167 0.237488 7.99167 0.212488 7.875C0.187488 7.75833 0.174988 7.63333 0.174988 7.5C0.174988 7.36667 0.187488 7.24167 0.212488 7.125C0.237488 7.00833 0.274988 6.90833 0.324988 6.825C1.35832 4.775 2.82082 3.125 4.71249 1.875C6.60415 0.625 8.69999 0 11 0C13.3 0 15.3958 0.625 17.2875 1.875C19.1792 3.125 20.6417 4.775 21.675 6.825C21.725 6.90833 21.7625 7.00833 21.7875 7.125C21.8125 7.24167 21.825 7.36667 21.825 7.5C21.825 7.63333 21.8125 7.75833 21.7875 7.875C21.7625 7.99167 21.725 8.09167 21.675 8.175C20.6417 10.225 19.1792 11.875 17.2875 13.125C15.3958 14.375 13.3 15 11 15Z"
                      fill="#687076"
                    />
                  </svg>
                </span>
            ...
            {selectedDataSource && (addingQuery || editingQuery) && (
              ...
              >
                <span style={{ paddingRight: '10px', color: '#3A5CCC' }}>Run</span>
                <span>
                  <svg width="6.9" height="8.54" viewBox="0 0 11 14" fill="#3A5CCC" xmlns="http://www.w3.org/2000/svg">
                    <path
