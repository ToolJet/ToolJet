                    ...
                    <div>
                        <div class="mb-3 mt-2 col-md-2">
                            <SelectSearch 
                                ...
                                value={options.mode} 
                                search={true}
                                onChange={(value) => { this.changeOption('mode', value) }}
                                ...
                                <div className="row">
                                    <div class="col">
                                        ...
                                        <input 
                                            ...
                                            onChange={(e) => { this.changeOption('table', e.target.value)}}
                                    ...
                                    <div class="col">
                                        ...
                                        <SelectSearch 
                                            ...
                                            search={true}
                                            onChange={(value) => { this.changeOption('operation', value) }}
                                            filterOptions={fuzzySearch}
                                            placeholder="Select.." 
                                        />
                                    </div>
                                    ...
                                    <div>
                                        <div class="mb-3 mt-2">
                                            ...
                                            <input 
                                                ...
                                                onChange={(e) => { this.changeOption('primary_key_column', e.target.value)}}
                                                className="form-control"
                                            />
                                        </div>
                                        <div class="mb-3 mt-2">
