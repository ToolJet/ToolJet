export const widgets = [
  ...
  },
  {
    ...
    styles: {
      ...
      visibility: { type: 'toggle', displayName: 'Visibility' },
      disabledState: { type: 'toggle', displayName: 'Disable' },
      verticalShadow: { type: 'number', displayName: 'Vertical Shadow' },
      horizontalShadow: { type: 'number', displayName: 'Horizontal Shadow' },
      shadowColor: { type: 'code', displayName: 'Shadow Color' },
      blur: { type: 'number', displayName: 'Blurx' },
