...
export const DraggableBox = function DraggableBox({ id, title, left, top, component, index, inCanvas, onEvent, onComponentClick, currentState, onComponentOptionChanged  }) {
