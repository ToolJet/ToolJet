        ...
        <div>
          ...
          <div className="row mt-3">
            ...
            <SelectSearch
              ...
              search={false}
              onChange={(value) => {
                optionchanged('grant_type', value);
              }}
              filterOptions={fuzzySearch}
              placeholder="Select.."
            />
            ...
            <SelectSearch
              ...
              search={false}
              onChange={(value) => {
                optionchanged('add_token_to', value);
              }}
              filterOptions={fuzzySearch}
              placeholder="Select.."
            />
            ...
            {addTokenTo === 'header' && (
              <div className="col-md-12">
                ...
                <input
                  ...
                  value={options.header_prefix.value}
                />
              </div>
            )}
          </div>
          ...
          {grantType === 'authorization_code' && (
            <div>
              ...
              <SelectSearch
                ...
                search={false}
                onChange={(value) => {
                  optionchanged('client_auth', value);
                }}
                filterOptions={fuzzySearch}
                placeholder="Select.."
              />
