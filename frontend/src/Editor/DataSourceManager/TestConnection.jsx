...
export const TestConnection = ({ kind, options  }) => {
    ...
    function testDataSource() {
        ...
        datasourceService.test(kind, options).then((data) => {
    ...
    return (
        <div>
            {connectionStatus === 'failed' &&
                <span className="badge bg-red-lt">could not connect</span>
            }

            {connectionStatus === 'success' &&
                <span className="badge bg-green-lt">connection verified</span>
            }
