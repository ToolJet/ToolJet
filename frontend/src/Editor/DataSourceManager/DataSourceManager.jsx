...
class DataSourceManagerComponent extends React.Component {
  ...
  selectDataSource = (source, category) => {
    posthog.capture('choose_datasource', { dataSource: source.kind, category, appId: this.state.appId });
    this.hideModal();
    this.setState(
      {
  ...
  renderCardGroup = (source, type) => {
    const openDataSourceConfirmModal = (dataSource, type) =>
      this.setState({
        dataSourceConfirmModalProps: {
          isOpen: true,
          dataSource,
          ...
          <div className="row row-deck mt-4 ">
            ...
            {filteredDatasources.map((item) => (
              <Card
                ...
                title={item.title}
                src={item.src}
                handleClick={() => openDataSourceConfirmModal(item, type)}
            ...
            <div className="row row-deck mt-4">
              ...
              {databases.map((item) => (
                <Card
                  ...
                  title={item.title}
                  src={item.src}
                  handleClick={() => openDataSourceConfirmModal(item, 'databases')}
                  usePluginIcon={true}
                  height="35px"
                  width="35px"
                />
            ...
            <div className="row row-deck mt-4">
              ...
              {apis.map((item) => (
                <Card
                  ...
                  title={item.title}
                  src={item.src}
                  handleClick={() => openDataSourceConfirmModal(item, 'apis')}
                  usePluginIcon={true}
                  height="35px"
                  width="35px"
                />
            ...
            <div className="row row-deck mt-4">
              ...
              {cloudStorages.map((item) => (
                <Card
                  ...
                  title={item.title}
                  src={item.src}
                  handleClick={() => openDataSourceConfirmModal(item, 'cloud storage')}
                  usePluginIcon={true}
                  height="35px"
                  width="35px"
                />
