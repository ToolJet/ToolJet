...
class ManageAppUsers extends React.Component {
  ...
  render() {
    ...
    const embeddableLink = `<iframe width="560" height="315" src="${appLink}${appId}" title="Tooljet app - ${appId}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
