...
const Comments = ({ ...params }) => {
  // left -> popup opens towards left
  // right -> pop opens towards right
  ...
  return (
    <label
      ...
      style={{ position: 'relative', maxWidth: 48, margin: '.2rem' }}
    >
      ...
      <div
        style={{ [placement]: 0, [autoPosition[placement]]: 'auto', top: 40, width: '30rem', maxWidth: '30rem' }}
        {...content}
        className={`card popover zoom-popover ${open ? 'show' : 'hide'}`}
      >
        <div className="card-status-start bg-primary" />
        <div className="card-header">
          <div className="avatar-list avatar-list-stacked">
            <span className="avatar avatar-sm avatar-rounded">GG</span>
            <span className="avatar avatar-sm avatar-rounded">MD</span>
            <span className="avatar avatar-sm avatar-rounded">LSD</span>
