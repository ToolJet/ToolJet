        ...
        <div className="col-auto mx-1">
          {isQueryBeingDeleted ? (
            ...
            <span
              ...
              style={{
                marginTop: '3px',
                filter: this.props.darkMode ? 'invert(1)' : '',
              }}
            >
              <div>
                <svg width="17.7" height="18.98" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M3.40002 19.35C2.86669 19.35 2.40419 19.1542 2.01252 18.7625C1.62086 18.3708 1.42502 17.9083 1.42502 17.375V3.375H1.15002C0.866691 3.375 0.629191 3.27917 0.437524 3.0875C0.245858 2.89583 0.150024 2.65833 0.150024 2.375C0.150024 2.09167 0.245858 1.85417 0.437524 1.6625C0.629191 1.47083 0.866691 1.375 1.15002 1.375H5.47502C5.47502 1.09167 5.57086 0.854167 5.76252 0.6625C5.95419 0.470833 6.19169 0.375 6.47502 0.375H11.525C11.8084 0.375 12.05 0.475 12.25 0.675C12.45 0.875 12.55 1.10833 12.55 1.375H16.85C17.1334 1.375 17.3709 1.47083 17.5625 1.6625C17.7542 1.85417 17.85 2.09167 17.85 2.375C17.85 2.65833 17.7542 2.89583 17.5625 3.0875C17.3709 3.27917 17.1334 3.375 16.85 3.375H16.575V17.375C16.575 17.9083 16.3792 18.3708 15.9875 18.7625C15.5959 19.1542 15.1334 19.35 14.6 19.35H3.40002ZM3.40002 3.375V17.375H14.6V3.375H3.40002ZM6.00002 14.475C6.00002 14.7083 6.08336 14.9083 6.25002 15.075C6.41669 15.2417 6.61669 15.325 6.85002 15.325C7.10002 15.325 7.30836 15.2417 7.47502 15.075C7.64169 14.9083 7.72502 14.7083 7.72502 14.475V6.25C7.72502 6 7.63752 5.7875 7.46252 5.6125C7.28752 5.4375 7.08336 5.35 6.85002 5.35C6.60002 5.35 6.39586 5.4375 6.23752 5.6125C6.07919 5.7875 6.00002 6 6.00002 6.25V14.475ZM10.275 14.475C10.275 14.7083 10.3625 14.9083 10.5375 15.075C10.7125 15.2417 10.9167 15.325 11.15 15.325C11.4 15.325 11.6084 15.2417 11.775 15.075C11.9417 14.9083 12.025 14.7083 12.025 14.475V6.25C12.025 6 11.9375 5.7875 11.7625 5.6125C11.5875 5.4375 11.3834 5.35 11.15 5.35C10.9 5.35 10.6917 5.4375 10.525 5.6125C10.3584 5.7875 10.275 6 10.275 6.25V14.475ZM3.40002 3.375V17.375V3.375Z"
                    fill="black"
                  />
                </svg>
              </div>
                      ...
                      <div className="data-pane">
                        <div className="queries-container">
                          <div className="queries-header  row d-flex align-items-center justify-content-between">
                            ...
                            <div
                              className="col-auto d-flex align-items-center px-3 py-1 rounded"
                              style={{
                                marginRight: '15px',
                                maxHeight: '30px',
