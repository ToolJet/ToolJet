...
import { getWorkspaceId, setWindowTitle, defaultWhiteLabellingSettings } from '@/_helpers/utils';
...
const EditorComponent = (props) => {
  ...
  const onNameChanged = (newName) => {
    ...
    setWindowTitle({ page: 'editor', appName: newName });
  };
  ...
  const callBack = async (data, startingPageHandle, versionSwitched = false) => {
    setWindowTitle({ page: 'editor', appName: data.name });
