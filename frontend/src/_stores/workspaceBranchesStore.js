  ...
  zustandDevTools(
    (set, get) => ({
      ...
      actions: {
        ...
        async createBranch(name, sourceBranchId, commitSha, confirmImport) {
          const newBranch = await workspaceBranchesService.create(name, sourceBranchId, commitSha, confirmImport);
