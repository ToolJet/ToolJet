...
/**
 * useConfirm - Generic confirmation dialog hook
 *
 * Provides a simple confirm dialog that returns a promise.
 * Used across the app for confirmation actions (delete, disable features, etc.)
 *
 * Example usage:
 * ```
    ...
    ({ confirmButtonText = '', cancelButtonText = '', darkMode }) => {
      return (
        ...
        >
          ...
          <Modal.Body data-cy={'confirmation-modal-message'}>{message}</Modal.Body>
          <Modal.Footer
            style={{
          ...
          >
            ...
            <button
              ...
              data-cy={'confirmation-modal-confirm-btn'}
            >
