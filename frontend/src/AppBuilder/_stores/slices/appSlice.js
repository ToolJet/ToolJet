...
export const createAppSlice = (set, get) => {
  // Lets a newer switchPage cancel an older, still-running doSwitch instead
  // of it mutating state in the background after being superseded.
  const _switchGeneration = {};
