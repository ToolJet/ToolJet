...
// Wrap ChatMessage in React.memo to prevent unnecessary re-renders
export const ChatMessage = React.memo(
  ({ chat, userName, respondentName, userAvatar, respondentAvatar, computedStyles }) => {
    console.log('chat message rendered');
    return (
      <div
