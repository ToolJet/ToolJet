...
const PDF = React.memo(
  ({ styles, properties, width, height, componentName, dataCy, setExposedVariable, setExposedVariables }) => {
    ...
    return (
      <div style={{ display: isVisible ? 'flex' : 'none', width: width - 3, height, boxShadow }} data-cy={dataCy}>
        <div
