...
export const TableExposedVariables = ({
  ...
  useEffect(() => {
    ...
    // Skip firing when the click came from the selection checkbox and enableRowClickOnCheckbox is off.
    if (allowSelection && Object.keys(lastClickedRow).length > 0 && !lastClickedRow.skipRowClickEvent) {
