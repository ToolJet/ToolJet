...
export const Filter = memo(({ id, table, darkMode, setFilters, setShowFilter, dataCy }) => {
  ...
  return (
    <div className={`table-filters card ${darkMode ? 'dark-theme theme-dark' : 'light-theme'}`} data-cy={`table-${dataCy}-filter-panel`}>
