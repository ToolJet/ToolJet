...
export const CustomDropdown = ({
  ...
  const checkForValidValue = (value) => {
    ...
    const nonPremitiveValueExits = value.find(
      (singleValue) => typeof singleValue === "object"
    );
  ...
  function renderValue(valueProps) {
    if (!isEditable && valueProps) {
      ...
      const arrayOfValueProps = stringifyValue.includes(",")
        ? stringifyValue.split(", ")
        : stringifyValue.split(" ");
      return (
        <div>
