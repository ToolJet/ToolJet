...
/**
 * HTMLRenderer - Pure HTML value renderer with editing support
 *
 * Renders HTML content with optional editing, validation, and overlay for overflow.
 *
 * @param {Object} props
 * @param {string} props.value - The HTML value to render
    ...
    return (
      ...
      >
        {isEditing ? (
          ...
          <span className="html-cell h-100" dangerouslySetInnerHTML={{ __html: getCellValue(value) }} />
        )}
      </div>
    );
  };
