...
/**
 * SelectRenderer - Shared select dropdown renderer
 *
 * Pure UI component for rendering select/multiselect dropdowns.
 * Context-independent - all dependencies are passed as props.
 * Validation is handled by widget-specific adapters.
 */
export const SelectRenderer = ({
  ...
  useEffect(() => {
    ...
    if (!isMulti && !isNewRow && widgetType !== 'KeyValuePair') return;
