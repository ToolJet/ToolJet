export const popoverMenuConfig = {
    ...
    definition: {
        ...
        properties: {
            ...
            schema: {
                value:
                    '{{[{"label":"option1","description":"Description1","disable":false,"visible":true},{"label":"option2","description":"Description1","disable":false,"visible":true},{"label":"option3","description":"Description1","disable":false,"visible":true}]}}',
            },
            options: {
                value: [
                    {
