...
const ModulesEmptyStateIcon = ({ className = '', width = '24', height = '24', fill = 'currentColor' }) => {
  return (
    <svg width="300" height="207" viewBox="0 0 300 207" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_110_8961)">
        ...
        <g filter="url(#filter0_d_110_8961)">
          <path
...
export default ModulesEmptyStateIcon;
