        ...
        >
          <div className="application-brand">
            <Link to="/">
              ...
              >
                <rect width="44" height="44" rx="6" fill="#3E63DD" />
                <g clipPath="url(#clip0_426_15227)">
                  <path
                    d="M20.7677 36C20.7677 34.0536 20.7549 32.1768 20.7779 30.3018C20.7831 29.8855 20.6621 29.6026 20.3657 29.3112C18.3839 27.3605 16.4207 25.3911 14.4567 23.4218C14.3026 23.2672 14.1493 23.2034 13.9295 23.2043C12.0703 23.2128 10.2102 23.2094 8.35101 23.2094C8.23688 23.2094 8.1219 23.2094 8.00948 23.2094C8.00607 23.1644 7.99585 23.1397 8.00352 23.1244C8.74193 21.6954 9.33811 20.1882 10.2963 18.879C11.1062 17.7729 12.1257 16.9555 13.531 16.7567C13.9909 16.6913 14.4635 16.7083 14.9303 16.7041C15.759 16.6964 16.5877 16.6939 17.4163 16.7075C17.6437 16.7109 17.78 16.6302 17.9188 16.456C20.3751 13.3601 23.3798 10.9566 27.0131 9.36445C29.047 8.47237 31.1651 7.95072 33.4067 8.0034C34.255 8.02379 35.105 8.0068 35.9516 8.0068C35.972 8.05013 35.9976 8.07731 35.9967 8.1045C35.989 9.36529 36.0257 10.6295 35.9584 11.8869C35.8443 14.0364 35.1484 16.0346 34.1937 17.9453C32.5951 21.1466 30.3551 23.8304 27.5463 26.0445C27.3632 26.1889 27.2789 26.3316 27.2823 26.5721C27.2976 27.5364 27.2627 28.5023 27.2942 29.4658C27.3478 31.1123 26.6852 32.4173 25.4111 33.4062C24.8039 33.8777 24.1302 34.2745 23.4539 34.6466C22.5929 35.1198 21.6986 35.5344 20.766 35.9991L20.7677 36ZM29.466 16.6845C29.4583 15.4832 28.4934 14.5274 27.2908 14.53C26.0925 14.5325 25.1173 15.5019 25.1156 16.6922C25.1139 17.8884 26.1197 18.885 27.3146 18.8705C28.5121 18.8561 29.4736 17.8791 29.466 16.6837V16.6845Z"
                    fill="#FDFDFE"
                  />
                  <path
                    d="M16.3279 30.8439C14.7599 32.9263 12.4501 33.6765 9.88062 34.0673C10.3771 31.5814 10.9972 29.2161 13.1221 27.635C14.1825 28.6962 15.2573 29.7726 16.3279 30.8439Z"
                    fill="#FDFDFE"
                  />
                </g>
                <defs>
                  <clipPath id="clip0_426_15227">
