...
const BaseDisablePasswordLoginModal = ({ show, disablePasswordLogin, setShowModal, reset, modalContentEE }) => {
  const handleDisable = () => {
  ...
  const modalContent = modalContentEE ? (
    modalContentEE
  ) : (
    <div>
...
export default BaseDisablePasswordLoginModal;
