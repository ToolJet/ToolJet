...
class ManageGroupPermissionResourcesComponent extends React.Component {
  ...
  render() {
    ...
    const workflowSelectOptions = appsNotInGroup
            ...
            <div>
              ...
              <nav className="nav nav-tabs groups-sub-header-wrap">
                ...
                >
                  <SolidIcon
                    className="manage-group-tab-icons"
                    fill={currentTab === 'workflows' ? '#3E63DD' : '#C1C8CD'}
                    name="grid"
                    width="16"
                  ></SolidIcon>
                  {this.props.t('header.organization.menus.manageGroups.permissionResources.workflows', 'Workflows')}
                </a>
                <a
