                      ...
                      <div className="row">
                        <div className="col-11">
                          <Select
                            ...
                            placeholder={'Select Datasources to add to the group'}
                          />
                        </div>
                        <div className="col-1">
                          <div
                            className={`btn btn-primary w-100 ${isAddingDataSources ? 'btn-loading' : ''} ${
                              selectedDataSourceIds.length === 0 ? 'disabled' : ''
                            }`}
