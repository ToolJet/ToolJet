...
import './_styles/multi-conditions.scss';
...
const RenderSortFields = ({
  ...
  return (
    <div className="mt-1 row-container">
      <div className="d-flex align-items-center fields-container mb-2" style={{ width: '100%' }}>
        {/* Column */}
        ...
        {/* Order + delete button grouped together */}
        <div className="col p-0" style={{ display: 'flex', alignItems: 'center' }}>
          <div style={{ flex: 1 }}>
            <Select
              useMenuPortal={true}
          ...
          <div
            className={`delete-filter-btn ${darkMode ? 'delete-filter-btn-dark' : ''}`}
...
const RenderFilterFields = ({
  ...
  return (
    <div className="mt-1 row-container">
      <div className="d-flex align-items-center fields-container" style={{ width: '100%' }}>
        {/* Column */}
        ...
        {/* Operator */}
        <div className="field col p-0" style={{ borderRadius: 0 }}>
          <Select
            useMenuPortal={true}
        ...
        {/* Value + delete button grouped together */}
