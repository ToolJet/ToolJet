...
export const SupabaseFilter = ({ operators = [], value, onChange, placeholders }) => {
  const darkMode = localStorage.getItem('darkMode') === 'true';
  const [listRowsOptions, setUpdateRowsOptions] = useState({ where_filters: value });
  ...
  function handleWhereFiltersChange(filters) {
    setUpdateRowsOptions({ where_filters: filters });
  }
...
export const SupabaseSort = ({ orders = [], value, onChange, placeholders }) => {
  const darkMode = localStorage.getItem('darkMode') === 'true';
  const [listRowsOptions, setUpdateRowsOptions] = useState({ order_filters: value });
  ...
  function handleOrderFiltersChange(filters) {
    setUpdateRowsOptions({ order_filters: filters });
  }
...
export const SupabaseColumn = ({ value, onChange, placeholders }) => {
  const darkMode = localStorage.getItem('darkMode') === 'true';
