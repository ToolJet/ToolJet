...
class InvitationPage extends React.Component {
    ...
    setPassword = (e) => {
        ...
        userService.setPasswordFromToken(token, password).then(data =>  {
                  ...
                  <div className="container-tight py-2">
                    ...
                    <div className="card-body">
                        ...
                        <div className="mb-2">
                            ...
                            <div className="input-group input-group-flat">
                                <input  onChange={this.handleChange} name="password_confirmation" type="password" className="form-control"  placeholder="Password"  autoComplete="off"/>
                                <span className="input-group-text">
                                </span>
                            </div>
                        </div>
