...
export async function getCompletion(openai: OpenAIApi, options: QueryOptions): Promise<string | {error: string, statusCode: number }> {
...
export async function getChatCompletion(openai: OpenAIApi, options: QueryOptions): Promise<string | {error: string, statusCode: number }> {
