...
:::note  
Under environmental variable please add correponding Tooljet database env variables. You can also refer env variable [**here**](/docs/setup/env-vars#tooljet-database). 
:::
