...
|:----------- |:----------- |
| On change | This event is triggered when the checkbox input value is changed. |
| On check (deprecated) | This event is triggered when the checkbox input is checked. |
| On uncheck (deprecated)| This event is triggered when the checkbox input is unchecked. |
