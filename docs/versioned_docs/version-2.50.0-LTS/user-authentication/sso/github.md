...
7. Obtain the Login URL from the **[General Settings](/docs/2.50.0-LTS/user-authentication/general-settings#login-url)** of the SSO page.
...
Once the GitHub SSO is configured (on ToolJet version **`2.28.0-ee2.12.2`** or above), ToolJet will expose the user info returned by the GitHub. The user info will be available under the `ssoUserInfo` property of the `currentUser` global variable. Check the **[Inspector](/docs/2.50.0-LTS/how-to/use-inspector)** doc to learn more.
