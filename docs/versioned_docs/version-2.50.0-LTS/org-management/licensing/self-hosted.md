...
1. Set up the instance and log in as a **[Super Admin](/docs/2.50.0-LTS/Enterprise/superadmin)**.
...
1. Log in as a **[Super Admin](/docs/2.50.0-LTS/Enterprise/superadmin)**, ensuring that you are on the correct instance URL.
...
**b)** You can directly reach out to us via **[Slack](https://join.slack.com/t/tooljet/shared_invite/zt-2rk4w42t0-ZV_KJcWU9VL1BBEjnSHLCA)** or **[email](mailto:hello@tooljet.com)** and we will be happy to provide you the support.
