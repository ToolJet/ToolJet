...
:::tip
- You can apply transformations to the query results. Refer to our transformations documentation for more details: **[Transformation Tutorial](/docs/2.50.0-LTS/tutorial/transformations)**
- Check out this how-to guide on **[bulk updating multiple rows](/docs/2.50.0-LTS/how-to/bulk-update-multiple-rows)** from a table component.
:::
