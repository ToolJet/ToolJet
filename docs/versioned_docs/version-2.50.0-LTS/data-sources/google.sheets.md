...
1. Proceed with the setup steps provided in the [Google OAuth 2.0 guide](/docs/2.50.0-LTS/setup/env-vars#google-oauth--optional-) to configure the necessary settings.
