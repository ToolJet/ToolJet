...
Learn more about **[Using Custom Parameters](/docs/2.50.0-LTS/how-to/use-custom-parameters)**.
...
Queries can be enhanced with transformations to modify the query results. ToolJet supports transformations using two programming languages: JavaScript & Python. Refer to the detailed documentation on **[Transformations](/docs/2.50.0-LTS/tutorial/transformations)** for more information.
...
:::info
Learn more about [Event Handlers and Actions](/docs/2.50.0-LTS/widgets/overview#component-event-handlers).
:::
