...
:::info
- The Canvas height and width can be adjusted from the [Global Settings](/docs/2.50.0-LTS/app-builder/left-sidebar#global-settings).
- When the [Pages drawer](/docs/2.50.0-LTS/tutorial/pages) on the left is opened or pinned, the canvas becomes horizontally scrollable.
