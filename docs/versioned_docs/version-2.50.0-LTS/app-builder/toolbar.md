...
:::tip
Learn more about multi-environment configuration **[here](/docs/2.50.0-LTS/release-management/multi-environment)**.
:::
...
:::tip
Versioning is also helpful when working with **[multiple environments](/docs/2.50.0-LTS/release-management/multi-environment)** like development, staging and production.
:::
...
Read more about Gitsync **[here](/docs/2.50.0-LTS/gitsync)**. 
### Undo or Redo
...
:::tip
Learn more about **[Sharing](/docs/2.50.0-LTS/app-builder/share)** your ToolJet applications.
:::
