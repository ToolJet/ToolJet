...
Check the detailed documentation for **[Pages](/docs/2.50.0-LTS/tutorial/pages)**.
...
Check the detailed guide on **[using Inspector](/docs/2.50.0-LTS/how-to/use-inspector)**.
...
- **App link**: The link to the application. This link can be used to share the application with other users of the workspace. If you want to share the application with users outside the workspace, you can make the application public from the **[Share](/docs/2.50.0-LTS/app-builder/share)** modal.
...
- **Export app**: Click on the [Export app](/docs/2.50.0-LTS/dashboard#export-app) button to export the application as a JSON file. You can import this JSON file in any other workspace to use the application.
