...
Click on `+Add` button of the [query manager](/docs/2.50.0-LTS/app-builder/query-panel#query-manager) and select the data source added in the previous step as the data source. Select the operation that you want to perform, fill in the required parameters and click on **Run** button to run the query.
...
:::info
Query results can be transformed using transformations. Read our [transformations documentation](/docs/2.50.0-LTS/tutorial/transformations).
:::
