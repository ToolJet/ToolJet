...
Let's take a look at the exposed variables of the currentUser property by clicking on the **[inspector](/docs/2.50.0-LTS/app-builder/left-sidebar#inspector)** icon on the left sidebar:
