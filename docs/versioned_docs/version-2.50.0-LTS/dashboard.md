...
Furthermore, the dashboard serves as a gateway to various essential sections, such as **[Workflows](/docs/workflows/overview)**, **[ToolJet Database](/docs/tooljet-db/tooljet-database/)**, **[Data Sources](/docs/data-sources/overview)**, **[Marketplace](/docs/marketplace/marketplace-overview)**, **[Workspace Settings](/docs/2.50.0-LTS/tutorial/manage-users-groups)**, **[Settings](/docs/2.50.0-LTS/Enterprise/superadmin#settings)**, and **[Audit logs](/docs/2.50.0-LTS/Enterprise/audit_logs)**. You can effortlessly navigate to these sections directly from the dashboard.
