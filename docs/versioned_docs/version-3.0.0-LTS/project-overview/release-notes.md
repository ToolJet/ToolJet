...
4. Highly configurable **[page management system](/docs/3.0.0-LTS/tutorial/pages)**
5. Revamped **[components](/docs/3.0.0-LTS/widgets/table)** with more styling and functionality customizations
6. Enhanced developer experience in managing queries with the **[new query manager UI](/docs/3.0.0-LTS/app-builder/query-panel)**
...
1. **[Group Sync OIDC](/docs/3.0.0-LTS/user-authentication/sso/oidc)**: Easily manage user access to ToolJet applications from your Identity Provider (IDP) directly
2. **[Secrets constants](/docs/3.0.0-LTS/org-management/workspaces/workspace_constants#using-secrets)**: Ability to store encrypted credentials 
3. **[User metadata](/docs/3.0.0-LTS/tutorial/manage-users-groups#user-metadata)**: Store custom metadata with user details & access them while building applications
4. User roles: Revamped user groups with granular access control
5. **[User APIs](/docs/3.0.0-LTS/tutorial/tooljet-api#get-all-users)**: External API for creating and managing users
...
1. Introduction of **[loop node](/docs/3.0.0-LTS/workflows/nodes#loop-node)** to implement iterative processes
2. Improved error handling and debugger: Improved troubleshooting
3. Support for multiple deployment environments
4. **[Webhook triggers](/docs/3.0.0-LTS/workflows/workflow-triggers#webhooks)** to trigger workflows from external apps and services
5. **[Multiple result nodes](/docs/3.0.0-LTS/workflows/results)** for greater flexibility in defining the output

## Migration Steps

Ready to upgrade to ToolJet 3.0? Follow our migration guides:
- **[For Self-Hosted Users](/docs/setup/upgrade-to-v3)**
- **[For Cloud Users](/docs/3.0.0-LTS/setup/cloud-v3-migration)**
