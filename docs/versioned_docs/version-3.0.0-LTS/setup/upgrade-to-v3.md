...
For detailed instructions on migrating from Workspace Variables to Workspace Constants, please refer to our [Workspace Variables Migration Guide](/docs/3.0.0-LTS/org-management/workspaces/workspace-variables-migration).
