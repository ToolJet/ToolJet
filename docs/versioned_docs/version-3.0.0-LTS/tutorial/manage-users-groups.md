...
This guide explains how to manage users and groups in ToolJet. For an overview of the permission system, please refer to the [Permissions](/docs/3.0.0-LTS/org-management/permissions) documentation.
...
:::info
For detailed information on permissions, refer to the [Permissions](/docs/3.0.0-LTS/org-management/permissions) documentation.
:::
