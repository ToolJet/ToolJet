...
Now that we have created the *viewTabs* query, we can go to the **[Download PDF](/docs/3.0.0-LTS/how-to/print-multi-tabs-report#printing-data-from-multiple-tabs)** button and add the *viewTabs* query to the `On click` event handler.
