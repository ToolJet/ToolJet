...
:::tip
You can apply transformations to the query results. Refer to our transformations documentation for more information: [link](/docs/3.0.0-LTS/tutorial/transformations)
:::
