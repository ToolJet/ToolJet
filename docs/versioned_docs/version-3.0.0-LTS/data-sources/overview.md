...
3. Once the data source is added, you'll be required to input the configuration details for establishing a connection.
  ...
  ***Note: For paid plans, configuration entry and saving are necessary to enable availability across [multiple environments](/docs/3.0.0-LTS/release-management/multi-environment).***
...
Changing the **Permissions** for Data Sources is a privilege reserved for **Admins** and **[Super Admins](/docs/3.0.0-LTS/Enterprise/superadmin)** within the workspace.
