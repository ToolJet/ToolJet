...
:::tip
Please check the detailed doc on **[Permissions](/docs/3.0.0-LTS/org-management/permissions)**.
:::

- Administrators can manage [users and groups](/docs/3.0.0-LTS/tutorial/manage-users-groups) of each workspace.
...
- Only **[Super Admins](/docs/3.0.0-LTS/Enterprise/superadmin#restrict-creation-of-personal-workspace-of-users)** can disable the option for creating personal workspaces for a user.
