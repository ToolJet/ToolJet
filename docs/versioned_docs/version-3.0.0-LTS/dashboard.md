...
Furthermore, the dashboard serves as a gateway to various essential sections, such as **[Workflows](/docs/workflows/overview)**, **[ToolJet Database](/docs/tooljet-db/tooljet-database/)**, **[Data Sources](/docs/data-sources/overview)**, **[Marketplace](/docs/marketplace/marketplace-overview)**, **[Workspace Settings](/docs/user-management/role-based-access/custom-groups)**, **[Settings](//docs/user-management/role-based-access/super-admin)**, and **[Audit logs](/docs/security/audit-logs)**. You can effortlessly navigate to these sections directly from the dashboard.
