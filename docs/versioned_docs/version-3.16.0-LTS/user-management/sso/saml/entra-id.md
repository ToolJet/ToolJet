...
3. Return to your application in the Azure Developer Portal. Go to **Manage > Single sign-on**, edit **Attributes & Claims**, and add a new **Group Claim**. Under **Which groups associated with the user should be returned in the claim**, select **All groups** or whichever group types you need. Set the **Source attribute** to **Group ID**. Click **Save**.
