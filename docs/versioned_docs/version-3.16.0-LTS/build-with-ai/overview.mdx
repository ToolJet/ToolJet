    ...
    <Link to={href} style={{ textDecoration: 'none' }}>
        ...
        >
            ...
            <div>
                ...
                <div style={{ fontSize: '13px', color: 'var(--ifm-color-emphasis-700)', lineHeight: '1.5' }}>{description}</div>
            </div>
        </div>
    </Link>
);
    ...
    <Link to={href} style={{ textDecoration: 'none' }}>
        ...
        >
            ...
            <ul style={{ margin: 0, paddingLeft: '16px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                {features.map((f, i) => <li key={i} style={{ fontSize: '13px', color: 'var(--ifm-color-emphasis-700)' }}>{f}</li>)}
            </ul>
        </div>
    </Link>
);
...
export const Step = ({ n, title, desc, img, alt, tip, tipHref }) => (
    <div style={{ display: 'flex', gap: '14px', alignItems: 'flex-start', marginBottom: '20px' }}>
        ...
        <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: '13px', color: 'var(--ifm-color-emphasis-700)', lineHeight: '1.5' }}>{desc}</div>
            {tip && tipHref && (
            ...
            <img className="screenshot-full img-full" style={{ marginTop: '12px', marginBottom: '4px' }} src={img} alt={alt} />
        </div>
    </div>
);
...
<Step
    ...
    desc='Enter a prompt on the dashboard. e.g., "Order management system for a logistics company."'
...
<Step
    ...
    desc="Choose from PostgreSQL, MongoDB, or BigQuery to connect your real schema, or proceed with sample data to prototype quickly."
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '14px', marginBottom: '8px' }}>
    ...
    <FeatureCard
        ...
        description="Connect your PostgreSQL, MongoDB, or BigQuery schema. AI reads your tables and builds apps on top of your schema."
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '14px', marginBottom: '8px' }}>
    ...
    <ConfigCard
        ...
        description="Use your own LLM API key (Anthropic or OpenAI) instead of consuming ToolJet credits. Requests still route through ToolJet AI Cloud."
...
<Link to="/docs/build-with-ai/privacy" style={{ textDecoration: 'none' }}>
    ...
    >
        ...
        <div>
            ...
            <div style={{ fontSize: '13px', color: 'var(--ifm-color-emphasis-700)' }}>What data is shared with AI, how it's protected, and your deployment options.</div>
        </div>
    </div>
</Link>
