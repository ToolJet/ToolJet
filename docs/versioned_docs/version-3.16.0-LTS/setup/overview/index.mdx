...
<SetupSection description="Review the requirements and choose the right version before deploying" cols={2}>
...
<SetupSection description="Get up and running with ToolJet quickly">
    ...
    <SetupCard iconId="ecs" title="AWS Marketplace" description="Deploy ToolJet directly from the AWS Marketplace with pre-configured infrastructure. Get started in minutes." href="https://aws.amazon.com/marketplace/pp/prodview-fxjto27jkpqfg?sr=0-1&ref_=beagle&applicationId=AWSMPContessa" isExternal={true} />
    <SetupCard iconId="azure-marketplace" title="Azure Marketplace" description="Deploy ToolJet from the Microsoft Azure Marketplace as a virtual machine. Quick setup with Azure infrastructure." href="https://marketplace.microsoft.com/en-us/product/tooljetsolutioninc1679496832216.tooljet-vm?tab=Overview" isExternal={true} />
</SetupSection>
