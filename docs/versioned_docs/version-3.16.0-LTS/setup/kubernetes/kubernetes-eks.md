---
id: kubernetes-eks
title: Deploying ToolJet on Kubernetes (EKS)
...
2. Create a k8s Deployment: <br/>
   ...
   **Configure all required environment variables** in the `deployment.yaml`. We advise using secrets to set up sensitive information.
