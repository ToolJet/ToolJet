...
### ToolJet Managed AI Server with ToolJet Self-Hosted
...
Bring Your Own Key (BYOK) lets you configure your own LLM provider API key instead of using ToolJet-managed credentials. Requests still route through ToolJet Managed AI Server, only the credentials used to authenticate them change. This works on both ToolJet Cloud and self-hosted deployments.
