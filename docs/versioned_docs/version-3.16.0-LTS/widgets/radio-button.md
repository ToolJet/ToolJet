...
| Tooltip | Displays an informational tooltip when the user hovers over the component. Supports **Plain text**, **Markdown**, and **HTML** formats. | String (e.g., `Select an option`).                                                                                          |
