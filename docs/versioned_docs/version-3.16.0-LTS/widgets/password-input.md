...
| :------- | :---------- | :------------ |
|  value        | Holds the value entered by the user in the component. | `{{components.passwordinput1.value}}`       |
|  label        | Holds the value of the component's label.             | `{{components.passwordinput1.label}}`       |
|  isValid      | Indicates if the input meets validation criteria.     | `{{components.passwordinput1.isValid}}`     |
|  isMandatory  | Indicates if the field is required.                   | `{{components.passwordinput1.isMandatory}}` |
|  isLoading    | Indicates if the component is loading.                | `{{components.passwordinput1.isLoading}}`   |
|  isVisible    | Indicates if the component is visible.                | `{{components.passwordinput1.isVisible}}`   |
|  isDisabled   | Indicates if the component is disabled.               | `{{components.passwordinput1.isDisabled}}`  |
