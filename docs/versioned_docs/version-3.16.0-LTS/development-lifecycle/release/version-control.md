...
4. Select the **Create from version** dropdown that will include all the saved versions of the app, choose a version from the dropdown that you want to use for your new version or ToolJet will automatically select the last released version. A new draft version can only be created from a saved version.
