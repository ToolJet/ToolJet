...
<img style={{ border:'0', marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/iamnew.png" alt="aws s3 modal" />
...
<img style={{ border:'0', marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/instanew.png" alt="aws s3 modal" />
...
<img style={{ border:'0', marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/arnnew.png" alt="aws s3 modal" />
