...
<img className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/aws-S3-ds.png" alt="aws s3 data source" />
...
<img className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/iamnew.png" alt="aws s3 modal" />
...
<img className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/instanew.png" alt="aws s3 modal" />
...
<img className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/arnnew.png" alt="aws s3 modal" />
...
<img className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/aws-S3-ds2.png" alt="aws s3 modal" />
...
<img style={{marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/s3-create.png" alt="Create a new bucket - S3 operation" />
...
<img style={{marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/s3-read.png" alt="aws s3 read object" />
...
<img style={{marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/s3-upload.png" alt="aws s3 upload"/>
...
<img style={{marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/s3-remove.png" alt="Create a new bucket - S3 operation" />

### List Buckets

This operation will list all the buckets in your S3. This does not require any parameter.

<img style={{marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/s3-listBucket.png" alt="aws s3 bucket" />
...
<img style={{marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/s3-listObjBucket.png" alt="aws s3 list object" />
...
<img style={{marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/s3-signedURL.png" alt="aws s3 signed download" />
