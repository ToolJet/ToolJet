...
<img style={{marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/iam-ux-s3-conn.png" alt="aws s3 IAM connection" />
...
<img style={{marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/instanew.png" alt="aws s3 instance creds" />
...
<img style={{marginBottom:'15px'}} className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/arnnew.png" alt="aws s3 arn role" />

### Default Credential Provider Chain

You can also use **Default Credential Provider Chain**, for the connectivity.

<img className="screenshot-full img-full" src="/img/datasource-reference/aws-s3/aws-S3-ds2.png" alt="aws s3 default cred" />
