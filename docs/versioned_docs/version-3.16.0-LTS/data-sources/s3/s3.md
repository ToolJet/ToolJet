...
Once enabled, the **bucket parameter** becomes configurable directly within the query builder, allowing bucket values to be supplied dynamically at execution time instead of being statically defined in the datasource configuration. This helps reduce repetitive bucket declarations across multiple operations and improves query reusability.
:::
