...
Apart from [**events**](/docs/app-builder/events/overview), Component-Specific Actions (CSAs) can also be triggered using code to modify component properties and state.
