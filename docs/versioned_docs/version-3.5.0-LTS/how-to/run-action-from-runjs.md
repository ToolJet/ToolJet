...
); // generate a csv file named csvfile1 with the data from the current page of table
```
...
); // generate a text file named textfile1 with the data from the current page of table (stringified)
```
...
actions.generateFile(
  ...
  "pdf",
  "{{components.table1.currentPageData}}",
); // generate a text file named Pdffile1 with the data from the current page of table
```
