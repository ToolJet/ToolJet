...
- To perform queries on Supabase in ToolJet, click the **+Add** button in the [query manager](/docs/3.5.0-LTS/app-builder/query-panel#query-manager) located at the bottom panel of the editor.
