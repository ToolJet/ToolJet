...
:::tip
Check the **[Components Catalog](/docs/3.5.0-LTS/widgets/overview)** to know more about specific component.
:::
...
To open the Properties Panel, click on the **[component handle](/docs/3.5.0-LTS/app-builder/canvas#arrange-components)** that is present on the top of the component including **⚙️ + Component Name** and the Properties Panel will open up on the right side.
