...
:::info
- The Canvas height and width can be adjusted from the [Global Settings](/docs/3.5.0-LTS/app-builder/left-sidebar#global-settings).
- When the [Pages drawer](/docs/3.5.0-LTS/tutorial/pages) on the left is opened or pinned, the canvas becomes horizontally scrollable.
