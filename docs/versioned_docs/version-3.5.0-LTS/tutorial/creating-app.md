...
- **[Widgets](/docs/3.5.0-LTS/tutorial/adding-widget)** - UI components such as tables, buttons, dropdowns.
- **[Data sources](/docs/3.5.0-LTS/tutorial/adding-a-datasource)** - ToolJet can connect to databases, APIs and external services to fetch and modify data.
- **[Queries](/docs/3.5.0-LTS/tutorial/building-queries)** - Queries are used to access the connected data sources.