...
## Admins
**Admins** can create, edit, and manage workflows, access the dashboard, and use them in ToolJet's **App Builder**. They also have the option to use the **Enable** toggle on the top-right to enable or disable the execution of workflows in ToolJet applications.
