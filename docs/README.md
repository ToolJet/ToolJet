...
│   │   ├── Enterprise
│   │   │   └── multi-environment.md   # https://docs.tooljet.com/docs/3.0.0-LTS/release-management/multi-environment/
│   │   └── tooljet-database.md.       # https://docs.tooljet.com/docs/tooljet-db/tooljet-database/
│   └── version-2.0.0
│   │   ├── Enterprise
│   │   │   └── multi-environment.md   # https://docs.tooljet.com/docs/development-lifecycle/environment/self-hosted/multi-environment/
│   │   └── tooljet-database.md
│   └── version-1.0.0
│       ├── Enterprise
│       │   └── multi-environment.md   # https://docs.tooljet.com/docs/2.50.0-LTS/release-management/multi-environment/
│       └── tooljet-database.md
