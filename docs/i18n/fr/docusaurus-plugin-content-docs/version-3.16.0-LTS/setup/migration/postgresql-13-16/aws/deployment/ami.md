...
id: ami
title: AMI
slug: /setup/postgresql-13-16/aws/deployment/ami/
---

### 1. Télécharger le certificat sur l'instance AMI
...
### 2. Mettre à jour la configuration de l'environnement
...
### 3. Redémarrer l'application ToolJet
...
**Référence** : [Documentation de configuration AMI de ToolJet](https://docs.tooljet.com/docs/setup/ami)
