...
Les **composants** sont les briques de base des applications ToolJet, utilisés pour créer des interfaces utilisateur interactives. La **bibliothèque de composants**, située à droite, contient tous les [composants disponibles](#composants-disponibles). 

Les composants peuvent être ajoutés au canvas en les glissant-déposant sur le canvas à l'emplacement souhaité.
...
| **Select Inputs** | [Dropdown](/docs/widgets/dropdown/), [Multi-Select](/docs/widgets/multiselect/), [Toggle Switch](/docs/widgets/toggle-switch-v2/), [Radio Button](/docs/widgets/radio-button-v2/), [Checkbox](/docs/widgets/checkbox/), [Tree Select](/docs/widgets/tree-select/), [Cascader](/docs/widgets/cascader/) |
