...
Checkout example installations:
- **With subpath** -> https://staging-with-subpath.tooljet.com/installations/low-code/oss/tooljet/
- **Without subpath** -> https://tooljet-ce.u1tgj2vfnqgrm.ap-south-1.cs.amazonlightsail.com/
