...
2. In the app editor, navigate to the query panel at the bottom and create a **[RunJS query](../data-sources/run-js/#runjs-query-examples)** by selecting **Run JavaScript Code** as the datasource:
  <div style={{textAlign: 'center'}}>
