...
<img className="screenshot-full" src="/img/datasource-reference/minio-connect.png" />
...
<img className="screenshot-full" src="/img/datasource-reference/minio-query.png" />
