...
<img className="screenshot-full" src="/img/datasource-reference/aws-s3/aws-s3-modal.png" />
...
<img className="screenshot-full" src="/img/datasource-reference/aws-s3/aws-s3-query.png" />
...
<img className="screenshot-full" src="/img/datasource-reference/aws-s3/read-object.png" />
...
<img className="screenshot-full" src="/img/datasource-reference/aws-s3/upload-object.png" />
...
<img className="screenshot-full" src="/img/datasource-reference/aws-s3/list-buckets.png" />
...
<img className="screenshot-full" src="/img/datasource-reference/aws-s3/list-objects.png" />
...
<img className="screenshot-full" src="/img/datasource-reference/aws-s3/signed-download.png" />
...
<img className="screenshot-full" src="/img/datasource-reference/aws-s3/signed-upload.png" />
