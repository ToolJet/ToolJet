...
- The CSV file should not exceed 500 MB in size.
...
- `TOOLJET_DB_BULK_UPLOAD_MAX_CSV_FILE_SIZE_MB`: Specifies the maximum CSV file size for bulk uploads. The default maximum size is 500 MB.
:::
