...
| ----------- | ----------- | ----------- |
| Show on desktop | Makes the component visible in the desktop view. | You can set it with the toggle button or dynamically configure the value by clicking on **fx** and entering a logical expression. |
