...
| Min value         | Sets the minimum value allowed.                | Integer (e.g., `10` for a minimum of 6 characters). |
| Max value         | Sets the maximum value allowed.                | Integer (e.g., `1000` for a maximum of 12 characters).|
