...
<img className="screenshot-full" src="/img/gitsync/commitchanges-v2.png" alt="GitLab SSH Key" />
...
<img className="screenshot-full" src="/img/gitsync/gitlab/newversion-v2.png" alt="GitLab SSH Key" />
