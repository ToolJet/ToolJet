...
- Only **[Super Admins](/docs/Enterprise/superadmin#allow-users-to-create-personal-workspace)** can disable the option for creating personal workspaces for a user.
