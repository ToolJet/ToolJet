    ...
    },
    {
      ...
      'items': [
        ...
        },
        {
          ...
          'items': [
            'user-management-and-access-control/authentication/workspace-login',
            'user-management-and-access-control/authentication/pwd-login',
            'user-management-and-access-control/authentication/auto-sso',
            'user-management-and-access-control/authentication/direct-app',
          ]
        },
        {
          'type': 'category',
          ...
          'items': [
            'user-management-and-access-control/rbac/admin',
            'user-management-and-access-control/rbac/roles',
            {
              'type': 'category',
              'label': 'User Groups',
              'items': [
                'user-management-and-access-control/rbac/user-groups/default',
                'user-management-and-access-control/rbac/user-groups/custom'
              ]
            },
            'user-management-and-access-control/rbac/granular-access',
          ]
        },
        {
          'type': 'category',
          ...
          'items': [
            'user-management-and-access-control/sso/github',
            'user-management-and-access-control/sso/google',
            'user-management-and-access-control/sso/oidc',
            'user-management-and-access-control/sso/ldap',
            'user-management-and-access-control/sso/saml'
          ]
        },
        {
          'type': 'category',
          'label': 'Group Sync',
          'items': [
            'user-management-and-access-control/group-sync/oidc',
            'user-management-and-access-control/group-sync/ldap',
            'user-management-and-access-control/group-sync/saml'
          ]
        },
        'user-management-and-access-control/two-fa',
        {
          'type': 'category',
          ...
          'items': [
            {
              ...
              'items': [
                'user-management-and-access-control/managing-users/user-management/edit',
                'user-management-and-access-control/managing-users/user-management/metadata',
                'user-management-and-access-control/managing-users/user-management/reset-pwd'
              ]
            },
            'user-management-and-access-control/managing-users/user-profile'
          ]
        }
      ]
    },
