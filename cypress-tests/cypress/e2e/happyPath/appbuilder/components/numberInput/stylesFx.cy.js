...
describe('Number Input — stylesFx facet', { testIsolation: false }, () => {
    ...
    it.skip('label group — labelFontSize (Size) fx-code path [needs numeric-style-input fx helper]', () => {
        ...
        // type binding → assert [data-cy="numberinput1-label"] p font-size. source: numberinput.js:124
    ...
    it.skip('field group — borderRadius (Border radius) fx-code path [needs numeric-style-input fx helper]', () => {
        ...
        // type binding → assert -actionable-section border-radius. source: numberinput.js:256
    ...
    it('container group — padding has NO fx toggle (fxCapable:false negative case)', () => {
        ...
        // source: numberinput.js:271 (fxCapable:false)
        cy.get(commonWidgetSelector.parameterLabel('Padding')).should('exist');
        cy.get(commonWidgetSelector.parameterFxButton('Padding')).should('not.exist'); // source: numberinput.js:271
    });
    ...
    it.skip('label group — color (Text) fx-code path — RESOLVE-LIVE: token→hex', () => {
        ...
        // source: numberinput.js:118 (default numberinput.js:121)
        openEditorSidebar(W);
        cy.get(commonWidgetSelector.buttonStylesEditorSideBar).click();
        openAccordion('label', []);
        verifyAndModifyStylePickerFx(
            'Text', // NOTE: two 'Text' pickers exist (label color + field textColor); needs index disambiguation live
            'Text/Primary', // swatch token name (source: numberinput.js:121) — UNVERIFIED
            '#111111',
            0,
            '',
            false,
    ...
    it.skip('field group — backgroundColor (Background) fx-code path — RESOLVE-LIVE: token→hex', () => {
        ...
        // source: numberinput.js:205 (default numberinput.js:208)
        openEditorSidebar(W);
        cy.get(commonWidgetSelector.buttonStylesEditorSideBar).click();
        openAccordion('field', []);
        verifyAndModifyStylePickerFx(
            'Background',
            'Surface/Surface1', // UNVERIFIED token name (source: numberinput.js:208)
            '#222222',
            0,
            '',
            false,
    ...
    it.skip('field group — borderColor (Border) fx-code path — RESOLVE-LIVE: token→hex', () => {
        ...
        // source: numberinput.js:211 (default numberinput.js:214)
        openEditorSidebar(W);
        cy.get(commonWidgetSelector.buttonStylesEditorSideBar).click();
        openAccordion('field', []);
        verifyAndModifyStylePickerFx(
            'Border',
            'Border/Default', // UNVERIFIED token name (source: numberinput.js:214)
            '#333333',
            0,
            '',
            false,
    ...
    it.skip('field group — accentColor (Accent) fx-code path — RESOLVE-LIVE: token→hex', () => {
        ...
        // source: numberinput.js:217 (default numberinput.js:220)
        openEditorSidebar(W);
        cy.get(commonWidgetSelector.buttonStylesEditorSideBar).click();
        openAccordion('field', []);
        verifyAndModifyStylePickerFx(
            'Accent',
            'Brand/Primary', // UNVERIFIED token name (source: numberinput.js:220)
            '#444444',
            0,
            '',
            false,
    ...
    it.skip('field group — textColor (Text) fx-code path — RESOLVE-LIVE: token→hex + index', () => {
        ...
        // disambiguation. source: numberinput.js:223 (default numberinput.js:226)
        openEditorSidebar(W);
        cy.get(commonWidgetSelector.buttonStylesEditorSideBar).click();
        openAccordion('field', []);
        verifyAndModifyStylePickerFx(
            'Text',
            'Text/Primary', // UNVERIFIED token name (source: numberinput.js:226)
            '#555555',
            0,
            '',
            false,
    ...
    it.skip('field group — placeholderTextColor (Placeholder Text) fx-code path — RESOLVE-LIVE: token→hex', () => {
        ...
        // source: numberinput.js:229 (default numberinput.js:232)
        openEditorSidebar(W);
        cy.get(commonWidgetSelector.buttonStylesEditorSideBar).click();
        openAccordion('field', []);
        verifyAndModifyStylePickerFx(
            'Placeholder Text',
            'Text/Placeholder', // UNVERIFIED token name (source: numberinput.js:232)
            '#666666',
            0,
            '',
            false,
    ...
    it.skip('field group — errTextColor (Error text) fx-code path — RESOLVE-LIVE: token→hex', () => {
        ...
        // source: numberinput.js:235 (default numberinput.js:238)
        openEditorSidebar(W);
        cy.get(commonWidgetSelector.buttonStylesEditorSideBar).click();
        openAccordion('field', []);
        verifyAndModifyStylePickerFx(
            'Error text',
            'SystemStatus/Error', // UNVERIFIED token name (source: numberinput.js:238)
            '#777777',
            0,
            '',
            false,
    ...
    it.skip('field group — boxShadow fx-code path — RESOLVE-LIVE: fx render format', () => {
        ...
        // source: numberinput.js:262 (default '0px 0px 0px 0px #00000040')
        openEditorSidebar(W);
        cy.get(commonWidgetSelector.buttonStylesEditorSideBar).click();
        openAccordion('field', []);
        verifyAndModifyStylePickerFx(
            'Box Shadow',
            '#00000040', // trailing color (source: numberinput.js:262) — prefix UNVERIFIED
