import { commonSelectors, whiteLabelSelectors, commonWidgetSelector } from "Selectors/common";
...
describe("Instance settings - White labelling", () => {
    ...
    it("should verify white label in user invitation email and on onboarding flow", () => {
        ...
        verifyCustomLogo(whiteLabelSelectors.tooljetHeaderImg, whitelabelTestData.logoIdentifier);
        verifyPageTitleAndFavicon(
