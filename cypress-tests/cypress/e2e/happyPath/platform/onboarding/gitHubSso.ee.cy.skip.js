...
describe("GitHub SSO Tests", () => {
  ...
  const WORKSPACE_SETTINGS_URL =
    "/my-workspace/workspace-settings/workspace-login";
  ...
  const ERROR_MESSAGES = {
    USER_NOT_EXIST_SIGNUP:
      "GitHub login failed - User does not exist, please sign up",
  ...
  it("should verify signup via sso to instance", () => {
    ...
    cy.verifyToastMessage(
      ...
      ERROR_MESSAGES.USER_NOT_EXIST_SIGNUP
    );
  ...
  it("should verify signup via sso to workspace", () => {
    ...
    cy.verifyToastMessage(
      commonSelectors.toastMessage,
      ERROR_MESSAGES.USER_NOT_IN_WORKSPACE
    );
