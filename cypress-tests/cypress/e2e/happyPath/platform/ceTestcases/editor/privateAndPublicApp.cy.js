...
import { fetchAndVisitInviteLink,verifyConfirmEmailPage,visitWorkspaceInvitation} from "Support/utils/onboarding";
...
describe(
  ...
  () => {
    ...
    it.skip("Should redirect to the workspace login page, allow signup, proceed to accept invite page, and load the app", () => {
      data.firstName = fake.firstName;
      data.email = fake.email.toLowerCase();
