...
describe("Manage SSO for single workspace", () => {
  ...
  it("Should verify General settings page elements", () => {
    ...
    cy.get(ssoSelector.pagetitle)
      .should("be.visible")
      .and("have.text", ssoText.pagetitle);

    cy.get(ssoSelector.generalSettings)
      .should("be.visible")
      .and("have.text", ssoText.generalSettings);
    cy.get(ssoSelector.cardTitle)
      .should("be.visible")
      .and("have.text", ssoText.generalSettings);
    cy.get(ssoSelector.enableCheckbox).should("be.visible");
    cy.get(ssoSelector.enableSignupLabel)
      .should("be.visible")
      .and("have.text", ssoText.enableSignupLabel);
    cy.get(ssoSelector.helperText)
      .should("be.visible")
      .and("have.text", ssoText.helperText);
    cy.get(ssoSelector.domainLabel)
      .should("be.visible")
      .and("have.text", ssoText.domainLabel);
    cy.get(ssoSelector.domainInput).should("be.visible");
    cy.get(ssoSelector.cancelButton)
      .should("be.visible")
      .and("have.text", ssoText.cancelButton);
    cy.get(ssoSelector.saveButton)
      .should("be.visible")
      .and("have.text", ssoText.saveButton);
  ...
  it("Should verify Google SSO page elements", () => {
    ...
    cy.get(ssoSelector.cardTitle)
      ...
      .and("be.visible");
    cy.get(ssoSelector.enableCheckbox).should("be.visible");
    cy.get(ssoSelector.clientIdLabel)
      .should("be.visible")
      .and("have.text", ssoText.clientIdLabel);
    ...
    cy.get(ssoSelector.redirectUrlLabel)
      .should("be.visible")
      .and("have.text", ssoText.redirectUrlLabel);
    ...
    cy.get(ssoSelector.googleSignInText)
      .should("be.visible")
      .and("have.text", ssoText.googleSignInText);
  });
  ...
  it("Should verify Git SSO page elements", () => {
    ...
    cy.get(ssoSelector.clientSecretLabel)
      ...
      .and("be.visible");
    cy.get(ssoSelector.encriptedLabel)
      .should("be.visible")
      .and("have.text", ssoText.encriptedLabel);
    ...
    cy.get(ssoSelector.gitSignInText)
      .should("be.visible")
      .and("have.text", ssoText.gitSignInText);
  });
