...
describe("User permissions", ()=>{
  ...
  it("Should verify the create new app permission", ()=>{
   permissions.addNewUserMW(data.firstName,data.lastName,data.email,data.companyName);
  ...
  it("Should verify the View and Edit permission", ()=>{
   ...
   cy.contains('td', data.appName).parent().within(() => {
   ...
   cy.get(commonSelectors.appCard(data.appName)).should('contain.text', data.appName);
   cy.contains('div', data.appName).parent().within(() => {
   ...
   cy.contains('tr', data.appName).parent().within(() => {
