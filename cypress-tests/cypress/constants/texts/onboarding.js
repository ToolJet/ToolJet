export const onboardingText = {
  ...
  signUpTermsHelperTextCommunity:
  ...
  freeTrialHeaderText:
    "Before we dive in, would you like to start your free trial?",
  ...
  defaultPrice: "$0",
  infoDescriptionText:
    "Build & scale your internal tools faster than ever with our advanced features.",
  adminUserRole: "Admin",
  builderUserRole: "Builder",
  endUserRole: "End-user",
  userMetadataLabel: "User metadata",
};
