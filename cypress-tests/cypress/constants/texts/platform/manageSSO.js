export const ssoText = {
  ...
  ldapSSOAttributeElements: {
    addBaseDn: "+ Add another Base DN",
    baseDnHelperText: 'Location without UID or CN. Add multiple to search across different OUs.',
    attributeLabel: 'Username attribute',
    attributeCNLabel: 'CNe.g. Amy Wong',
    attributeUPNLabel: 'UPNe.g. amy@contoso.local',
    attributeHelperText: 'Users log in with their Common Name (CN). Each Base DN is tried in order until a match is found.',
    groupsyncLabel: 'Enable group sync',
    groupsyncHelperText: 'Sync user groups from your IdP',
  },
  samlSSOPageElements: {
    nameLabel: 'Name',
  ...
  ldapTitle: "LDAP",
  attributeCNHelperText: 'Users log in with their Common Name (CN). Each Base DN is tried in order until a match is found.',
  attributeUPNHelperText: 'Users log in with their full User Principal Name (UPN). Base DN is used only to look up profile attributes.',
  samlTitle: "SAML",
