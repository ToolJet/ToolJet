...
export const commonText = {
  ...
  passwordResetEmailToast: "Please check your email/inbox for the password reset link",
  ...
  resetPasswordPageDescription:"Your password has been reset successfully, log into ToolJet to continue your session",
