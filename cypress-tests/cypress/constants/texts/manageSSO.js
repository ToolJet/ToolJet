export const ssoText = {
  ...
  instanceLoginPage: {
    ...
    domainConstraintsHelperText: "This is applicable only for users that sign up without invite. Enter multiple domains by comma separated values. Example: tooljet.com, tooljet.io",
