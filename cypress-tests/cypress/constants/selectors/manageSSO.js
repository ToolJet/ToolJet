export const ssoSelector = {
  ...
  ldapSSOAttributeElements: {
    addBaseDn: '[data-cy="add-base-dn"]',
    baseDnHelperText: '[data-cy="base-dn-helper-text"]',
    attributeLabel: '[data-cy="bind-attribute-label"]',
    attributeCNLabel: '[data-cy="bind-attribute-cn"] + span',
    attributeUPNLabel: '[data-cy="bind-attribute-upn"] + span',
    attributeHelperText: '[data-cy="bind-attribute-helper-text"]',
    groupsyncLabel: '[data-cy="group-sync-toggle-label"]',
    groupsyncHelperText: '[data-cy="group-sync-helper-text"]',
  },
  samlSSOPageElements: {
    nameLabel: '[data-cy="name-label"]',
    nameInput: '[data-cy="name-input"]',
  ...
  googleEnableToggle: '[data-cy="google-toggle-input"] > .slider',
