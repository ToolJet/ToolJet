...
export const multiEnvSelector = {
    ...
    inspectorButtonAria: 'button[aria-label="Inspector"]',
    inspectorComponentsNode: '[data-cy="inspector-components-node"]',
    inspectorMenuIcon: '[data-cy="inspector-menu-icon"]',
