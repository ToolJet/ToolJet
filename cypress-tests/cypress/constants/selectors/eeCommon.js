...
export const ssoEeSelector = {
  ...
  baseDnInput: '[data-cy="base-dn-input-0"]',
  addBaseDn: '[data-cy="add-base-dn"]',
  attributeCNRadio: '[data-cy="bind-attribute-cn"]',
  attributeUPNRadio: '[data-cy="bind-attribute-upn"]',
  groupsyncToggle: '[data-cy="group-sync-toggle-input"]',
