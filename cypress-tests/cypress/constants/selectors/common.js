...
export const commonSelectors = {
  ...
  dashboardAppCreateButton: '[data-cy="create-an-app-button"]:eq(1)',
  appCreateButton: "[data-cy=create-an-app-button]:eq(0)",
  ...
  workspaceName: '[data-cy="workspace-selector-trigger"]>span',
  ...
  appNameInput: '[data-cy="app-name-input"]',
  appNameInfoLabel: '[data-cy="app-name-error-label"]',
  createAppButton: '[data-cy="create-front-end-button"]',
  renameApptitle: '[data-cy="rename-app-title"]',
  renameAppButton: '[data-cy="rename-front-end-button"]',
  cloneAppTitle: '[data-cy="clone-app-title"]',
  cloneAppButton: '[data-cy="clone-front-end-button"]',
  ...
  CreateAppFromTemplateButton: '[data-cy="create-from-template-front-end-button"]',
