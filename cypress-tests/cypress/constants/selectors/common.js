...
export const commonSelectors = {
  ...
  userNameInputLabel: '[data-cy="name-label"]',
  ...
  emailInputLabel: '[data-cy="email-label"]',
  ...
  passwordHelperText: '[data-cy="password-hint"]',
  ...
  nameInputField: '[data-cy="name-input"]',
  emailInputField: '[data-cy="email-input"]',
