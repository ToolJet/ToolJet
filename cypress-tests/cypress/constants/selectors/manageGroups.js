...
export const groupsSelector = {
  ...
  appPrmoteHelperText: '[data-cy="app-promote-helper-text"]',
  ...
  workflowsHelperText: '[data-cy="workflow-helper-text"]',
  ...
  datasourcesHelperText: '[data-cy="datasource-helper-text"]',
