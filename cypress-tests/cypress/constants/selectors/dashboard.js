...
export const dashboardSelector = {
  ...
  appsMultiSelectControl: '[data-cy="move-selected-app-to-text"] .react-select__control',
  appsMultiSelectValueRemove: '[data-cy="move-selected-app-to-text"] .react-select__multi-value__remove',
