...
export const manageGroupsElements = () => {
  cy.get(groupsSelector.pageTitle)
    .should("be.visible")
    .and("have.text", groupsText.pageTitle);
  cy.get(groupsSelector.createNewGroupButton)
    .should("be.visible")
    .and("have.text", groupsText.createNewGroupButton);
  cy.get(groupsSelector.tableHeader)
    .should("be.visible")
    .and("have.text", groupsText.tableHeader);
  cy.get(groupsSelector.groupName)
    .contains(groupsText.allUsers)
    .should("be.visible")
    .and("have.text", groupsText.allUsers);
  cy.get(groupsSelector.groupName)
    .contains(groupsText.admin)
    .should("be.visible")
    .and("have.text", groupsText.admin);
  cy.get(groupsSelector.createNewGroupButton).should("be.visible").click();
  cy.get(groupsSelector.cardTitle)
    .should("be.visible")
    .and("have.text", groupsText.cardTitle);
  ...
  cy.get(groupsSelector.createGroupButton)
    .should("be.visible")
    .and("have.text", groupsText.createGroupButton);
  ...
  cy.get(groupsSelector.resourcesFolders)
    .should("be.visible")
    .and("have.text", groupsText.resourcesFolders);
  cy.get(groupsSelector.foldersCreateCheck).should("be.visible").check();
  cy.get(groupsSelector.foldersCreateLabel)
    .should("be.visible")
    .and("have.text", groupsText.folderCreateLabel);
