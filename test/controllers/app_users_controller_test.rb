...
class OrganizationUsersControllerTest < ActionDispatch::IntegrationTest
    def setup
        ...
        @org_admin = User.create({first_name: "Admin", email: "admin@example.com", password: "password", organization: @org })
        @org_developer = User.create({first_name: "Dev", email: "dev@example.com", password: "password", organization: @org })
        @org_viewer = User.create({first_name: "Viewer", email: "viewer@example.com", password: "password", organization: @org })
