    ...
    for (const version of appVersions) {
      ...
      if (definition) {
        ...
        for (const componentId of Object.keys(components)) {
          ...
          if (component.component.component === 'Multiselect') {
            component.component.definition.properties.values = component.component.definition.properties.value;
            component.component.definition.properties.option_values = component.component.definition.properties.values;
