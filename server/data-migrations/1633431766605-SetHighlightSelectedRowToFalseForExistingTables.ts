...
export class SetHighlightSelectedRowToFalseForExistingTables1633431766605 implements MigrationInterface {
      ...
      if (definition) {
        ...
        for (const componentId of Object.keys(components)) {
          ...
          if (component.component.component === 'Table') {
            component.component.definition.properties.highlightSelectedRow = { value: false };
