  ...
  describe('EE (plan: enterprise)', () => {
    ...
    describe('POST /api/organization-users', () => {
      ...
      it('should invite a new user to the workspace', async () => {
        ...
        expect(user).toMatchObject({ firstName: 'test', lastName: 'test' });
    ...
    describe('GET /api/onboarding/verify-organization-token', () => {
      let adminUser: User;
      let adminOrg: Organization;
      let loggedAdmin: any;
      ...
      it('should verify organization invite token for cross-workspace invite', async () => {
        ...
        expect(response.body).toMatchObject({ email: 'other@tooljet.com' });
      });
    });
    ...
    describe('POST /api/onboarding/accept-invite', () => {
      ...
      it('should accept a workspace invite', async () => {
        ...
        expect(orgUser).toMatchObject({ status: 'active' });
      });
    });
