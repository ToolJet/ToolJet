...
export class DataQueriesService {
  ...
  async update(user: User, dataQueryId: string, name: string, options: Record<string, any>): Promise<DataQuery> {
  ...
  async runQuery(user: User, dataQuery: any, queryOptions: Record<string, any>): Promise<Record<string, any>> {
  ...
  async parseSourceOptions(options: any): Promise<Record<string, any>> {
  ...
  async parseQueryOptions(object: any, options: Record<string, any>): Promise<Record<string, any>> {
