...
export class DataSourcesService {
  ...
  async parseOptionsForCreate(options: Array<object>, resetSecureData = false, entityManager = this._dataSource.manager) {
    if (!options) return {};
  ...
  async parseOptionsForUpdate(dataSource: DataSource, options: Array<object>, entityManager = this._dataSource.manager) {
    if (!options) return {};
