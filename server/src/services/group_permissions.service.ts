...
export class GroupPermissionsService {
  ...
  async duplicateGroup(
    ...
    const existNameList = await this._dataSource.createQueryBuilder()
  ...
  async findApps(user: User, groupPermissionId: string): Promise<App[]> {
    return this._dataSource.createQueryBuilder(App, 'apps')
  ...
  async findAddableUsers(user: User, groupPermissionId: string, searchInput: string): Promise<User[]> {
    ...
    const adminUsers = await this._dataSource.createQueryBuilder(UserGroupPermission, 'user_group_permissions')
      .innerJoin(
        GroupPermission,
        'group_permissions',
    ...
    const builtQuery = this._dataSource.createQueryBuilder(User, 'user')
