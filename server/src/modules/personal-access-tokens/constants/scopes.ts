...
export const PAT_BUNDLE_MODULES: Record<PAT_BUNDLE, MODULES[]> = {
  ...
  [PAT_BUNDLE.WORKFLOWS]: [MODULES.WORKFLOWS, MODULES.WORKFLOW_FOLDER],
...
export const PAT_UNASSIGNED_MODULES: MODULES[] = [
  ...
  MODULES.CUSTOM_COMPONENT_LIBRARIES, // uploads code that runs inside apps; not granted pending a decision
