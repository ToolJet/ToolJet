...
export enum INSTANCE_SYSTEM_SETTINGS {
  ...
  SSL_FULLCHAIN_PEM = 'SSL_FULLCHAIN_PEM',
  SSL_PRIVKEY_PEM = 'SSL_PRIVKEY_PEM',
  SSL_CERT_PEM = 'SSL_CERT_PEM',
  SSL_CHAIN_PEM = 'SSL_CHAIN_PEM',
  SSL_ACQUIRED_AT = 'SSL_ACQUIRED_AT',
  SSL_EXPIRES_AT = 'SSL_EXPIRES_AT',
  SSL_PREVIOUS_DOMAIN = 'SSL_PREVIOUS_DOMAIN',
  SSL_DOMAIN_CHANGE_REQUESTED = 'SSL_DOMAIN_CHANGE_REQUESTED',
  SSL_NEW_DOMAIN = 'SSL_NEW_DOMAIN',
  SSL_ACCOUNT_KEY = 'SSL_ACCOUNT_KEY',
  SSL_ACME_CHALLENGE = 'SSL_ACME_CHALLENGE',
  //LLM KEY ENUMS
  LLM_KEY_ENV_CONFIGURED = 'LLM_KEY_ENV_CONFIGURED',
...
export function getDefaultInstanceSettings() {
  return {
    ...
    [INSTANCE_SYSTEM_SETTINGS.LLM_KEY_ENV_CONFIGURED]: 'false',
  };
}
