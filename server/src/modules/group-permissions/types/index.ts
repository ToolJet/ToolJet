...
interface Features {
  ...
  [FEATURE_KEY.CREATE_GRANULAR_DS_FOLDER_PERMISSIONS]: FeatureConfig;
  [FEATURE_KEY.UPDATE_GRANULAR_DS_FOLDER_PERMISSIONS]: FeatureConfig;
  [FEATURE_KEY.DELETE_GRANULAR_DS_FOLDER_PERMISSIONS]: FeatureConfig;
  [FEATURE_KEY.GET_ADDABLE_DS_FOLDERS]: FeatureConfig;
