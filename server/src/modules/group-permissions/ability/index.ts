    ...
    if (superAdmin || isAdmin) {
      can(
        [
          ...
          FEATURE_KEY.CREATE_GRANULAR_WORKFLOW_FOLDER_PERMISSIONS,
          FEATURE_KEY.UPDATE_GRANULAR_WORKFLOW_FOLDER_PERMISSIONS,
          FEATURE_KEY.DELETE_GRANULAR_WORKFLOW_FOLDER_PERMISSIONS,
          FEATURE_KEY.GET_ADDABLE_WORKFLOW_FOLDERS,
          FEATURE_KEY.CREATE_GRANULAR_MODULE_FOLDER_PERMISSIONS,
          FEATURE_KEY.UPDATE_GRANULAR_MODULE_FOLDER_PERMISSIONS,
          FEATURE_KEY.DELETE_GRANULAR_MODULE_FOLDER_PERMISSIONS,
          FEATURE_KEY.GET_ADDABLE_MODULE_FOLDERS,
          FEATURE_KEY.CREATE_GRANULAR_DATA_SOURCE_FOLDER_PERMISSIONS,
          FEATURE_KEY.UPDATE_GRANULAR_DATA_SOURCE_FOLDER_PERMISSIONS,
          FEATURE_KEY.DELETE_GRANULAR_DATA_SOURCE_FOLDER_PERMISSIONS,
          FEATURE_KEY.GET_ADDABLE_DATA_SOURCE_FOLDERS,
