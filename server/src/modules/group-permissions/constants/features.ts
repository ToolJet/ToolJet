...
export const FEATURES_EE: FeaturesConfig = {
  [MODULES.GROUP_PERMISSIONS]: {
    ...
    [FEATURE_KEY.CREATE_GRANULAR_FOLDER_DATA_SOURCE_PERMISSIONS]: {
      license: LICENSE_FIELD.VALID,
      auditLogsKey: 'GRANULAR_PERMISSION_FOLDER_DATA_SOURCE_CREATE',
    },
    [FEATURE_KEY.UPDATE_GRANULAR_FOLDER_DATA_SOURCE_PERMISSIONS]: {
      license: LICENSE_FIELD.VALID,
      auditLogsKey: 'GRANULAR_PERMISSION_FOLDER_DATA_SOURCE_UPDATE',
    },
    [FEATURE_KEY.DELETE_GRANULAR_FOLDER_DATA_SOURCE_PERMISSIONS]: {
      license: LICENSE_FIELD.VALID,
      auditLogsKey: 'GRANULAR_PERMISSION_FOLDER_DATA_SOURCE_DELETE',
    },
