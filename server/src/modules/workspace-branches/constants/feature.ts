...
export const FEATURES: FeaturesConfig = {
  [MODULES.WORKSPACE_BRANCHES]: {
    ...
    [FEATURE_KEY.CREATE_BRANCH]: { license: LICENSE_FIELD.GIT_SYNC },
    [FEATURE_KEY.SWITCH_BRANCH]: { license: LICENSE_FIELD.GIT_SYNC },
    [FEATURE_KEY.DELETE_BRANCH]: { license: LICENSE_FIELD.GIT_SYNC },
    [FEATURE_KEY.PUSH_WORKSPACE]: { license: LICENSE_FIELD.GIT_SYNC },
    [FEATURE_KEY.PULL_WORKSPACE]: { license: LICENSE_FIELD.GIT_SYNC },
