...
export const FEATURES: FeaturesConfig = {
  [MODULES.LOGIN_CONFIGS]: {
    ...
    [FEATURE_KEY.SAVE_OIDC_ENV_CONFIGS]: { license: LICENSE_FIELD.OIDC },
    [FEATURE_KEY.SAVE_INSTANCE_OIDC_ENV_CONFIGS]: { license: LICENSE_FIELD.OIDC },
    [FEATURE_KEY.SAVE_SAML_ENV_CONFIGS]: { license: LICENSE_FIELD.SAML },
    [FEATURE_KEY.SAVE_LDAP_ENV_CONFIGS]: { license: LICENSE_FIELD.LDAP },
  },
};
