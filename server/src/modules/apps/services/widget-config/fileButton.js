export const fileButtonConfig = {
  ...
  validation: {
    ...
    minFileCount: {
      ...
      conditionallyRender: [
        { key: 'enableMultiple', value: true, parentObjectKey: 'properties' },
      ],
    },
    maxFileCount: {
      type: 'code',
  ...
  // render identically. Keep in sync with frontend/src/AppBuilder/WidgetManager/widgets/fileButton.js.
  styles: {
    buttonType: {
      type: 'switch',
      displayName: 'Type',
