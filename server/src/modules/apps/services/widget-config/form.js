export const formConfig = {
  ...
  defaultChildren: [
    ...
    },
    {
      ...
      properties: ['text'],
      accessorKey: 'text',
      styles: ['fontWeight', 'textSize', 'textColor', 'direction'],
      defaultValue: {
        text: 'Who are you',
        textSize: 12,
        direction: 'left',
    ...
    },
    {
      ...
      styles: ['alignment', 'width', 'auto', 'padding', 'visibility'],
      defaultValue: {
        placeholder: 'Tomy',
        value: 'Pet name',
        width: '{{60}}',
    ...
    },
    {
      ...
      properties: ['placeholder', 'label'],
      styles: ['alignment', 'width', 'auto', 'direction'],
      defaultValue: {
