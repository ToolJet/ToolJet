...
import { OrganizationIdValidationGuard } from '@modules/auth/guards/organizationIdValidation.guard';
...
export class TooljetDbController {
  ...
  @UseGuards(JwtAuthGuard, OrganizationIdValidationGuard, FeatureAbilityGuard)
  ...
  @UseGuards(JwtAuthGuard, OrganizationIdValidationGuard, TableCountGuard, FeatureAbilityGuard)
