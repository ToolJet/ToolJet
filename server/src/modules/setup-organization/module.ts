  ...
  static async register(configs?: { IS_GET_CONTEXT: boolean }, isMainImport?: boolean): Promise<DynamicModule> {
    ...
    return {
      ...
      providers: !isMainImport
        ? [SetupOrganizationsUtilService, OrganizationRepository, OrganizationUsersRepository, DataSourcesRepository]
        : [
      ...
      exports: isMainImport ? [] : [SetupOrganizationsUtilService],
    };
  }
}
