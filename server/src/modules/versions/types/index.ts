...
interface Features {
  ...
  [FEATURE_KEY.APP_VERSION_CREATE]: FeatureConfig;
  [FEATURE_KEY.APP_VERSION_DELETE]: FeatureConfig;
  [FEATURE_KEY.APP_DRAFT_VERSION_CREATE]: FeatureConfig;
  [FEATURE_KEY.APP_VERSION_UPDATE]: FeatureConfig;
