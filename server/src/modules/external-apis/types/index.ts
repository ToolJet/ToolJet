...
interface Features {
  ...
  [FEATURE_KEY.IMPORT_TJDB_TABLE_AS_CSV]: FeatureConfig;
  [FEATURE_KEY.UPDATE_TJDB_TABLE_AS_CSV]: FeatureConfig;
  [FEATURE_KEY.DELETE_TJDB_TABLE_AS_CSV]: FeatureConfig;
  [FEATURE_KEY.UPDATE_USER_METADATA]: FeatureConfig;
  [FEATURE_KEY.GET_USER_METADATA]: FeatureConfig;
  ...
  [FEATURE_KEY.CREATE_WORKSPACE_V2]: FeatureConfig;
  [FEATURE_KEY.LIST_WORKSPACES_V2]: FeatureConfig;
  [FEATURE_KEY.GET_WORKSPACE_V2]: FeatureConfig;
  [FEATURE_KEY.UPDATE_WORKSPACE_V2]: FeatureConfig;
  [FEATURE_KEY.ARCHIVE_WORKSPACE_V2]: FeatureConfig;
  [FEATURE_KEY.UNARCHIVE_WORKSPACE_V2]: FeatureConfig;
  [FEATURE_KEY.SET_DEFAULT_WORKSPACE_V2]: FeatureConfig;
  [FEATURE_KEY.CREATE_WORKSPACE_USER_V2]: FeatureConfig;
  [FEATURE_KEY.BULK_CREATE_WORKSPACE_USERS_V2]: FeatureConfig;
  [FEATURE_KEY.LIST_WORKSPACE_USERS_V2]: FeatureConfig;
  [FEATURE_KEY.GET_WORKSPACE_USER_V2]: FeatureConfig;
  [FEATURE_KEY.UPDATE_WORKSPACE_USER_V2]: FeatureConfig;
  [FEATURE_KEY.BULK_UPDATE_WORKSPACE_USERS_V2]: FeatureConfig;
  [FEATURE_KEY.ARCHIVE_WORKSPACE_USER_V2]: FeatureConfig;
  [FEATURE_KEY.UNARCHIVE_WORKSPACE_USER_V2]: FeatureConfig;
  [FEATURE_KEY.LIST_WORKSPACE_USER_GROUPS_V2]: FeatureConfig;
}
