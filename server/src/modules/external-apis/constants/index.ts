export enum FEATURE_KEY {
  ...
  IMPORT_TJDB_TABLE_AS_CSV = 'IMPORT_TJDB_TABLE_AS_CSV',
  UPDATE_TJDB_TABLE_AS_CSV = 'UPDATE_TJDB_TABLE_AS_CSV',
  DELETE_TJDB_TABLE_AS_CSV = 'DELETE_TJDB_TABLE_AS_CSV',
  ...
  EXPORT_APP_ADMIN = 'EXPORT_APP_ADMIN',
  GET_WORKSPACE_USERS_BY_GROUPS = 'GET_WORKSPACE_USERS_BY_GROUPS',
  LIST_USERS_V2 = 'LIST_USERS_V2',
  GET_USER_V2 = 'GET_USER_V2',
  UPDATE_USER_V2 = 'UPDATE_USER_V2',
  ARCHIVE_USER_V2 = 'ARCHIVE_USER_V2',
  UNARCHIVE_USER_V2 = 'UNARCHIVE_USER_V2',
  LIST_USER_WORKSPACES_V2 = 'LIST_USER_WORKSPACES_V2',
}
